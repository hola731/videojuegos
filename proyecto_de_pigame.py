...
def mostrar_pantalla_inicio():
    ...
    while True:
        ...
        # Título del juego
        dibujar_texto(pantalla, "DESTRUYE LOS CÍRCULOS", 64, ANCHO // 2, ALTO // 4, CYAN)
        
        # Botones
        boton_iniciar = pygame.Rect(ANCHO // 2 - 100, ALTO // 2 - 90, 200, 50)
        boton_infinito = pygame.Rect(ANCHO // 2 - 100, ALTO // 2 - 30, 200, 50)
        boton_config = pygame.Rect(ANCHO // 2 - 100, ALTO // 2 + 30, 200, 50)
        boton_salir = pygame.Rect(ANCHO // 2 - 100, ALTO // 2 + 90, 200, 50)
        ...
        dibujar_texto(pantalla, "CONFIGURACIÓN", 24, ANCHO // 2, ALTO // 2 + 40, NEGRO)
        dibujar_texto(pantalla, "SALIR", 24, ANCHO // 2, ALTO // 2 + 100, NEGRO)
